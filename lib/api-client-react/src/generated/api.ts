 ...
 */
export const getPortfolio = async ( options?: Parameters<typeof customFetch>[1]): Promise<PortfolioDocument> => {

  return customFetch<PortfolioDocument>(getGetPortfolioUrl(),
  {
    ...options,
    method: 'GET'
 ...
 */
export const updatePortfolio = async (portfolioDocument: PortfolioDocument, options?: Parameters<typeof customFetch>[1]): Promise<PortfolioDocument> => {

  return customFetch<PortfolioDocument>(getUpdatePortfolioUrl(),
  {
    ...options,
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(portfolioDocument)
  }
);}
...
export const getUpdatePortfolioMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updatePortfolio>>, TError,{data: BodyType<PortfolioDocument>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updatePortfolio>>, TError,{data: BodyType<PortfolioDocument>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updatePortfolio>>, {data: BodyType<PortfolioDocument>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdatePortfolioMutationBody = BodyType<PortfolioDocument>
...
export const useUpdatePortfolio = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updatePortfolio>>, TError,{data: BodyType<PortfolioDocument>}, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        {data: BodyType<PortfolioDocument>},
        TContext
      > => {
