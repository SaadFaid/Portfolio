...
function Toolkit() {
  ...
  return (
    <section id="stack" className="border-y border-foreground/20 bg-white text-[hsl(var(--background))]">
      <div className="mx-auto max-w-[1440px] px-6 py-24 lg:px-10 lg:py-36">
        <div className="reveal flex flex-col justify-between gap-8 border-b border-[hsl(var(--background)/.22)] pb-10 lg:flex-row lg:items-end"><div><p className="eyebrow font-mono-ui text-[hsl(var(--accent))]">04 / Toolkit</p><h2 className="mt-5 max-w-3xl font-display text-5xl font-bold uppercase leading-[.87] sm:text-7xl">The stack<br />behind the work.</h2></div><p className="max-w-sm text-sm leading-6 text-[hsl(var(--background)/.58)]">Recognizable tools, chosen for the problem in front of me. From structured data to the last interaction.</p></div>
